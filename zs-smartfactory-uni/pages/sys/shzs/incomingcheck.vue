	...
	<view class="wrap" style="padding-bottom: 60px;">
		<view>
			<u-form :model="form" class="apply-form-field">
				...
				<u-form-item label="来料批次号" class="marginLeft" label-width="150" right-icon="arrow-right">
					<u-input placeholder="请选择" v-model="productionline" @click="show = true" type="select" class="form-field-select"/>
					<u-action-sheet :list="actionSheetList" v-model="show" @click="actionSheetCallback"></u-action-sheet>
				</u-form-item>
				
				<!-- <u-gap height="20" bg-color="#f5f5f5"></u-gap> -->
				<u-form-item label="供应商" class="marginLeft" label-width="150" >
					<u-input placeholder="请输入" value="xxxx有限公司"  type="text" input-align="right"/>
				</u-form-item>
				<u-form-item label="检验方式" class="marginLeft"  label-width="150" right-icon="arrow-right">
					<u-input placeholder="请选择" type="select" class="form-field-select"/>
				</u-form-item>
				
				<u-form-item label="产品名称"  class="marginLeft"  label-width="180">
					<u-input type="text" placeholder="请输入"/>
				</u-form-item>
				
				<u-form-item label="来料数量"  class="marginLeft"  label-width="180">
					<u-input type="number" placeholder="请输入"/>
				</u-form-item>
				
				
				<u-gap height="20" bg-color="#f5f5f5"></u-gap>
				<u-form-item label="检查项目" label-width="180" :label-style="{'font-size':'35rpx'}">
					<view solt="right" @click="addItemList" style="flex:1;text-align: right;align-items: center;color: blue;">
						添加
					</view>
				</u-form-item>
				<u-gap height="20" bg-color="#f5f5f5"></u-gap>
				...
				<u-form-item >
					<view><u-button size="medium" type="primary" @click="navTo('/pages/sys/msg/index')">合格</u-button></view>
					<view><u-button style="margin-left: 25px;" size="medium" type="default" @click="navTo('/pages/sys/msg/index')">不合格</u-button></view>
					<view><u-button style="margin-left: 25px;" size="medium" type="default" @click="navTo('/pages/sys/msg/index')">让步接收</u-button></view>
				</u-form-item>
...
export default {
		...
		methods: {
			...
			addItemList(){
				...
				this.itemList.push({'head':'检验项次'+len,'open':true,'disabled':true});
			}
